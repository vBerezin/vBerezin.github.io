...
/***/ "./blocks-mobile/color-preview/index.js":
/*!**********************************************!*\
  !*** ./blocks-mobile/color-preview/index.js ***!
  \**********************************************/
  ...
  function Preview(node) {
    ...
    this.el.addEventListener('click', new _common_scripts_utils_handlers__WEBPACK_IMPORTED_MODULE_4__["Handlers"].Click({
      ...
      'color.preview.select.base': function colorPreviewSelectBase(_ref2) {
        ...
        _common_scripts_app__WEBPACK_IMPORTED_MODULE_5__["App"].stream.trigger('color.preview.select.base', {
          title: _this.title,
          image: _this.image
        });
        event.preventDefault();
      ...
      'color.preview.select.partner': function colorPreviewSelectPartner(_ref3) {
        ...
        _common_scripts_app__WEBPACK_IMPORTED_MODULE_5__["App"].stream.trigger('color.preview.select.partner', {
          title: _this.title,
          image: _this.image
        });
        event.preventDefault();
...
/* harmony import */ var _common_scripts_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ~common/scripts/popups */ "./common/scripts/popups.js");
...
(function () {
  ...
  node.addEventListener('submit', function (event) {
    ...
    if (checked) {
      ...
      _common_scripts_app__WEBPACK_IMPORTED_MODULE_0__["App"].stream.trigger('form.sizes.submit', data);
    }
  });
})();
...
var Header = function () {
  ...
  var toggle = new _blocks_button_menu__WEBPACK_IMPORTED_MODULE_0__["ButtonMenu"](button);
  var current = null;
...
/***/ "./blocks-mobile/header/scripts/header-menu.js":
/*!*****************************************************!*\
  !*** ./blocks-mobile/header/scripts/header-menu.js ***!
  \*****************************************************/
...
/***/ "./blocks-mobile/header/scripts/header-search.js":
/*!*******************************************************!*\
  !*** ./blocks-mobile/header/scripts/header-search.js ***!
  \*******************************************************/
...
var HeaderSearch = /*#__PURE__*/function () {
  function HeaderSearch(header, callback) {
    ...
    this.el = header;
    this.callback = callback;
    var search = header.querySelector('[data-rel="header.search"]');
    this.search = new _blocks_form_search__WEBPACK_IMPORTED_MODULE_4__["FormSearch"](search);
  }
...
/***/ "./blocks-mobile/menu-mobile/index.js":
/*!********************************************!*\
  !*** ./blocks-mobile/menu-mobile/index.js ***!
  \********************************************/
...
/* harmony import */ var _blocks_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ~blocks-mobile/menu-mobile */ "./blocks-mobile/menu-mobile/index.js");
...
var MenuSticky = function () {
  ...
  var handler = new _common_scripts_utils_handlers__WEBPACK_IMPORTED_MODULE_6__["Handlers"].Click({
    'search.open': function searchOpen(_ref) {
      var event = _ref.event;
      _blocks_mobile_header__WEBPACK_IMPORTED_MODULE_4__["Header"].search.toggle();
      event.preventDefault();
    },
    'menu.open': function menuOpen(_ref2) {
      var event = _ref2.event,
          target = _ref2.target;
      _blocks_mobile_header__WEBPACK_IMPORTED_MODULE_4__["Header"].menu.toggle();
      _blocks_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_5__["MenuMobile"].state = JSON.parse(target.dataset.menuState);
      event.preventDefault();
    }
  });
...
/***/ "./blocks-mobile/section-catalog/index.js":
/*!************************************************!*\
  !*** ./blocks-mobile/section-catalog/index.js ***!
  \************************************************/
/*! no exports provided */
...
/* harmony import */ var _blocks_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ~blocks-mobile/menu-mobile */ "./blocks-mobile/menu-mobile/index.js");
...
(function () {
  ...
  var handler = new _common_scripts_utils_handlers__WEBPACK_IMPORTED_MODULE_2__["Handlers"].Click({
    'menu.open': function menuOpen(_ref) {
      var event = _ref.event,
          target = _ref.target;
      _blocks_mobile_header__WEBPACK_IMPORTED_MODULE_0__["Header"].menu.open();
      _blocks_mobile_menu_mobile__WEBPACK_IMPORTED_MODULE_1__["MenuMobile"].state = JSON.parse(target.dataset.menuState);
      event.preventDefault();
    }
  });
...
(function () {
  ...
  _common_scripts_app__WEBPACK_IMPORTED_MODULE_0__["App"].stream.on('form.sizes.submit', function (data) {
  ...
  _common_scripts_app__WEBPACK_IMPORTED_MODULE_0__["App"].stream.on('form.color.submit', function (data) {
...
var icons = {
  back: new _blocks_icon__WEBPACK_IMPORTED_MODULE_4__["Icon"]({
    name: 'left',
    mods: 'center'
  }),
  dropdown: new _blocks_icon__WEBPACK_IMPORTED_MODULE_4__["Icon"]({
    name: 'sub',
    mods: 'center'
  }),
  link: new _blocks_icon__WEBPACK_IMPORTED_MODULE_4__["Icon"]({
    name: 'right',
    mods: 'center'
  })
};
...
/* harmony import */ var _blocks_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ~blocks/icon */ "./blocks/icon/index.js");


$.fn.owlCarousel.Constructor.Plugins.Navigation.Defaults.navText = [new _blocks_icon__WEBPACK_IMPORTED_MODULE_1__["Icon"]({
  name: 'left',
  mods: 'center'
}).outerHTML, new _blocks_icon__WEBPACK_IMPORTED_MODULE_1__["Icon"]({
  name: 'right',
  mods: 'center'
}).outerHTML];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_owl_carousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ~blocks/owl-carousel */ "./blocks/owl-carousel/index.js");
...
/***/ "./blocks/slider-products/index.js":
/*!*****************************************!*\
  !*** ./blocks/slider-products/index.js ***!
  \*****************************************/
/*! no static exports found */
...
(function () {
  var nodes = document.querySelector('.js-slider-products');
