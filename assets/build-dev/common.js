...
var App = function () {
  ...
  var overlay = function () {
    var el = document.getElementById('js-overlay');
    if (el) return el;
    el = document.createElement('div');
...
$(document).on(App.triggers.ajax, function (event, args) {
...
/* harmony import */ var _lazy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lazy */ "./common/lazy.js");
/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./menu */ "./common/menu.js");
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./header */ "./common/header.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sidebar */ "./common/sidebar.js");
/* harmony import */ var _forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./forms */ "./common/forms.js");
/* harmony import */ var _sections__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sections */ "./common/sections.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (_app__WEBPACK_IMPORTED_MODULE_1__["default"].userAgent.isIE) {
...
/***/ "./common/classes/class-lazy-image.js":
/*!********************************************!*\
  !*** ./common/classes/class-lazy-image.js ***!
  \********************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function LazyImg(obj, src, onLoad, onError) {
  ...
  _createClass(LazyImg, [{
    ...
    value: function load() {
      ...
      this.loadImg(this.url).then(function (node) {
        var replaced = _this.replace(node);

        _this.el = replaced;
        return typeof _this.onLoad === 'function' && _this.onLoad(replaced);
      }).catch(function (error) {
        return typeof _this.onError === 'function' && _this.onError(error);
      });
    }
  }, {
    key: "loadImg",
    value: function loadImg(url) {
      return new Promise(function (resolve, reject) {
        ...
        img.onerror = function () {
          reject(new Error("load error:".concat(url)));
        };
...
/* harmony default export */ __webpack_exports__["default"] = (LazyImg);
...
/***/ "./common/components/breakpoints.js":
/*!******************************************!*\
  !*** ./common/components/breakpoints.js ***!
  \******************************************/
/*! exports provided: default */
...
var breakpoints = function () {
  var breakpointsHandler = function breakpointsHandler() {
    var value = breakpoints.getValue();
    var event = new CustomEvent('breakpoints.change', {
      detail: {
        breakpoints: {
          value: value
        }
  ...
  return {
     ...
     * */
    currentOf: function currentOf(string) {
      var _this = this;

      var arr = string.split(' ').filter(function (breakpoint) {
        return breakpoint === _this.current;
      });
     ...
     * */
    onBreakpoint: function onBreakpoint(string, fn, cb) {
      var _this2 = this;
     ...
     * @returns { (function|string) } результат fn() cb() или текущий брейкпоинт
     * */
    onEach: function onEach(string, fn, cb) {
      var _this3 = this;
      ...
      var handler = function handler(data) {
        if (_this3.current !== last) {
          last = _this3.current;

          if (_this3.currentOf(string)) {
...
(function ($) {
  ...
  initForms($('body'));
  _app__WEBPACK_IMPORTED_MODULE_0__["default"].stream.add(initForms);
})(jQuery);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return sendForm; });
...
function sendForm(event, onSuccess, onError, options) {
  event.preventDefault();
  ...
  if (typeof FormData !== 'undefined' && options && options.data) {
  ...
  _app__WEBPACK_IMPORTED_MODULE_0__["default"].preloader.add();
  $form.data('submitted', true);
  $form.find('[type="submit"]').attr('disabled', 'disabled').addClass('is-disabled is-loading');
  return $.ajax(config).done(function (response) {
    ...
    var data = $.extend(ajaxResponse, {
      form: event.target,
      html: ajaxResponse.html ? ajaxResponse.html : false,
      success: ajaxResponse.success ? ajaxResponse.success : false
    });
    ...
    $form.find('[type="submit"]').removeAttr('disabled').removeClass('is-disabled is-loading');
    _app__WEBPACK_IMPORTED_MODULE_0__["default"].preloader.remove();
  }).fail(_app__WEBPACK_IMPORTED_MODULE_0__["default"].onAjaxFail);
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "../../../node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./common/forms/form-error.js":
/*!************************************!*\
  !*** ./common/forms/form-error.js ***!
  \************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return formError; });
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return formSuccess; });
/**
 * @description обработчик успеха формы
 * */
function formSuccess(data) {
  ...
  var actions = {
    'success.close': function successClose(event) {
      event.preventDefault();
  ...
  $html.on('click', '[data-action]', function (event) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./common/app.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./common/utils.js");
...
(function () {
  ...
  var parentOffset = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getOffset"])(parent);
  var scrollBreakpoint = parentOffset.top + parent.offsetHeight;

  var scrollHandler = function scrollHandler() {
    requestAnimationFrame(function () {
      if (window.scrollY > scrollBreakpoint) {
        parent.style.minHeight = "".concat(parent.offsetHeight, "px");
        header.classList.add('is-fixed');
      } else {
        header.classList.remove('is-fixed');
        header.parentNode.style.minHeight = '';
      }
    });
  };

  _app__WEBPACK_IMPORTED_MODULE_0__["default"].breakpoints.onBreakpoint('lg xl xxl', function () {
    parentOffset = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getOffset"])(parent);
    scrollBreakpoint = parentOffset.top + parent.offsetHeight;
    scrollHandler();
...
/***/ "./common/jquery-plugins/owl-destroy.js":
/*!**********************************************!*\
  !*** ./common/jquery-plugins/owl-destroy.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return owlDestroy; });
function owlDestroy(owl) {
  if (!owl) {
    return false;
  }
...
var lazyObserver = function () {
  var nodes = document.querySelectorAll('.js-lazy-img, .js-lazy-iframe, .js-observe');
  var actions = {
    ...
    image: function image(node) {
      var _node$dataset = node.dataset,
          ...
          alt = _node$dataset.alt,
          title = _node$dataset.title;
      var altAttr = alt || node.alt || '';
      var titleAttr = title || node.title || '';
      return new _classes_class_lazy_image__WEBPACK_IMPORTED_MODULE_1__["default"](node, src, function (loadedImg) {
        var img = loadedImg;
        var classes = "".concat(node.getAttribute('class'), " a-opacity is-loaded");
    ...
    iframe: function iframe(node) {
      ...
      var classes = "".concat(node.getAttribute('class'), " a-opacity");
      iframe.src = src;
  ...
  var observerCallback = function observerCallback(entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        if (entryClass.contains('js-observe')) {
          entry.target.classList.remove('js-observe');
          return actions.visible(entry.target);
        }

        if (entryClass.contains('js-lazy-img')) {
          entry.target.classList.remove('js-lazy-img');
          return actions.image(entry.target);
        }

        if (entryClass.contains('js-lazy-iframe')) {
          entry.target.classList.remove('js-lazy-iframe');
          return actions.iframe(entry.target);
        }
      }
  ...
  var server = new IntersectionObserver(observerCallback, {
    root: null,
    rootMargin: '0% 0px',
    threshold: 0.1
  });
...
var menuAnchorScroll = function menuAnchorScroll(menu, cb) {
  ...
  function clickHandler(event) {
    ...
    if (section) {
      event.preventDefault();
      var offset = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getOffset"])(section).top;

      if (_app__WEBPACK_IMPORTED_MODULE_0__["default"].breakpoints.currentOf('xl xxl') && header) {
  ...
  $(menu).on('click', '[href^="#"]', clickHandler);
};

menuAnchorScroll(document.getElementById('js-menu-main'));
...
(function () {
  ...
  function createData(roots) {
    ...
    function parseItem(li) {
      ...
      if (dropdown) {
        children = _toConsumableArray(dropdown.children).map(function (item) {
    ...
    function makeRoot(root) {
      ...
      return _toConsumableArray(root.ul.children).map(function (item) {
        return parseItem(item);
      });
    }
  ...
  _app__WEBPACK_IMPORTED_MODULE_0__["default"].breakpoints.onBreakpoint('xxs xs sm md', function () {
    if (!menuMobile) {
      __webpack_require__.e(/*! import() | menu-app */ "menu-app").then(__webpack_require__.bind(null, /*! ./classes/class-menu-app */ "./common/classes/class-menu-app.js")).then(function (module) {
        ...
        menuAnchorScroll(menuMobile.menu, function () {
          menuMobile.close();
        });
        return MenuApp;
      }).catch(function (error) {
    ...
    if (menuMobile && menuMobile.close && menuMobile.active) menuMobile.close();
  });
  return menuMobile;
})();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "../../../node_modules/jquery/dist/jquery.js")))
...
$(document).on('click contextmenu', '.js-ajax-popup', function (event) {
  ...
  var url = btn.dataset.url || btn.href || '';
  ...
  $.ajax(url).done(function (html) {
    var popup = new _classes_class_popup__WEBPACK_IMPORTED_MODULE_0__["default"](html, {
      transition: 500,
      classname: btn.dataset.popupClass || ''
    });
...
/* harmony import */ var _sections_panels__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sections/panels */ "./common/sections/panels.js");
/* harmony import */ var _sections_faq__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sections/faq */ "./common/sections/faq.js");
...
/* harmony import */ var _jquery_plugins_owl_destroy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../jquery-plugins/owl-destroy */ "./common/jquery-plugins/owl-destroy.js");




(function () {
  var section = document.querySelector('.js-section-steps');
  if (!section) return false;
  var slider = section.querySelector('[data-action="steps.slider"]');
  if (!slider) return false;
  _app__WEBPACK_IMPORTED_MODULE_0__["default"].breakpoints.onBreakpoint('lg xl xxl', function () {
    Object(_jquery_plugins_owl_destroy__WEBPACK_IMPORTED_MODULE_2__["default"])(slider);
  }, function () {
    $(slider).addClass('owl-carousel').owlCarousel({
      items: 3,
      margin: 0,
...
(function () {
  var section = document.querySelector('.js-section-panels');
  if (!section) return false;
  var slider = section.querySelector('[data-action="panels.slider"]');
  if (!slider) return false;
...
(function () {
  ...
  function init(item) {
    ...
    var thumbsReize = thumbsCrop(thumbs, gallery);
    return {
      updateThumbs: thumbsReize.update,
      resetThumbs: thumbsReize.reset
    };
  }
  ...
  setSlide(current);
  _app__WEBPACK_IMPORTED_MODULE_0__["default"].breakpoints.onEach('lg xl xxl', function () {
    if (items[current]) items[current].updateThumbs();
  }, function () {
    if (items[current]) items[current].resetThumbs();
  });
  return section;
})();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "../../../node_modules/jquery/dist/jquery.js")))
...
(function () {
  ...
  var sidebar = document.getElementById('js-main-sidebar');

  if (toggles && toggles.length && sidebar) {
    _app__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.self.addEventListener('click', function () {
      sidebar.classList.remove('is-expanded');

      _toConsumableArray(toggles).forEach(function (node) {
        return node.classList.remove('is-active');
      });

      _app__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.remove();
    });
    ...
    _toConsumableArray(toggles).forEach(function (toggle) {
      toggle.addEventListener('click', function (event) {
        ...
        _toConsumableArray(toggles).forEach(function (node) {
          return node.classList.toggle('is-active');
        });
        ...
        if (sidebar.classList.contains('is-expanded')) {
          _app__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.add();
        } else {
          _app__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.remove();
        }
      });
...
/**
 * @function { getOffset } - позиция относительно документа
 * */
