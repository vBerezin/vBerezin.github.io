...
/*!******************************************************************!*\
  ...
  \******************************************************************/
/*! no static exports found */function(e,t){function r(e,t,r,n,s,o,i){try{var a=e[o](i),c=a.value}catch(e){return void r(e)}a.done?t(c):Promise.resolve(c).then(n,s)}e.exports=function(e){return function(){var t=this,n=arguments;return new Promise((function(s,o){var i=e.apply(t,n);function a(e){r(i,s,o,a,c,"next",e)}function c(e){r(i,s,o,a,c,"throw",e)}a(void 0)}))}}},"../node_modules/@babel/runtime/helpers/classCallCheck.js":
/*!****************************************************************!*\
...
/*!*************************************!*\
  ...
  \*************************************/
/*! exports provided: Breakpoints */function(e,t,r){"use strict";r.r(t),r.d(t,"Breakpoints",(function(){return p}));var n=r(/*! @babel/runtime/helpers/slicedToArray */"../node_modules/@babel/runtime/helpers/slicedToArray.js"),s=r.n(n),o=r(/*! @babel/runtime/helpers/classCallCheck */"../node_modules/@babel/runtime/helpers/classCallCheck.js"),i=r.n(o),a=r(/*! @babel/runtime/helpers/createClass */"../node_modules/@babel/runtime/helpers/createClass.js"),c=r.n(a),u=r(/*! @babel/runtime/helpers/classPrivateFieldGet */"../node_modules/@babel/runtime/helpers/classPrivateFieldGet.js"),l=r.n(u),d=r(/*! @babel/runtime/helpers/classPrivateFieldSet */"../node_modules/@babel/runtime/helpers/classPrivateFieldSet.js"),h=r.n(d);function f(e,t,r){if(!t.has(e))throw new TypeError("attempted to get private field on non-instance");return r}var p=function(){function e(t){var r=this;i()(this,e),v.add(this),b.set(this,{writable:!0,value:void 0}),m.set(this,{writable:!0,value:void 0}),this.current="",this.points={},h()(this,m,[]),h()(this,b,new Set),Object.entries(t).forEach((function(e){var t=s()(e,2),n=t[0],o=t[1],i=parseInt(o,10),a=window.matchMedia("(min-width: ".concat(i,"px)"));a.addListener((function(){return f(r,v,y).call(r)})),l()(r,m).push({name:n,screen:i,media:a}),r.points[n]=i})),l()(this,m).sort((function(e,t){return e.screen-t.screen})),f(this,v,y).call(this)}return c()(e,[{key:"indexOf",value:function(e){var t=this,r=[].concat(e).filter((function(e){return e===t.current}));return r.length?r:null}},{key:"once",value:function(e,t,r){var n=this,s=!0,o=!0,i=function(i){if(n.indexOf(e)){if(t&&s)return s=!1,o=!0,t(i)}else if(r&&o)return o=!1,s=!0,r(i)};l()(this,b).add(i),i(this.current)}},{key:"on",value:function(e,t,r){var n=this,s=function(s){if(n.indexOf(e)){if(t)return t(s)}else if(r)return r(s)};l()(this,b).add(s),s(this.current)}},{key:"change",value:function(e){var t=this,r=this.current;this.current&&e(this.current),l()(this,b).add((function(n){t.current!==r&&(r=t.current,e(n))}))}}]),e}(),b=new WeakMap,m=new WeakMap,v=new WeakSet,y=function(){var e=this,t=l()(this,m).filter((function(e){return e.media.matches}));this.current=t.length?t.slice(-1)[0].name:null,l()(this,b).forEach((function(t){return t(e.current)}))}},"./blocks/button/index.js":
/*!********************************!*\
...
/*!****************************************!*\
  ...
  \****************************************/
/*! exports provided: ItemSubscribe */function(e,t,r){"use strict";r.r(t),r.d(t,"ItemSubscribe",(function(){return h}));var n=r(/*! @babel/runtime/helpers/classCallCheck */"../node_modules/@babel/runtime/helpers/classCallCheck.js"),s=r.n(n),o=r(/*! @babel/runtime/helpers/createClass */"../node_modules/@babel/runtime/helpers/createClass.js"),i=r.n(o),a=r(/*! @babel/runtime/helpers/classPrivateFieldGet */"../node_modules/@babel/runtime/helpers/classPrivateFieldGet.js"),c=r.n(a),u=r(/*! @babel/runtime/helpers/classPrivateFieldSet */"../node_modules/@babel/runtime/helpers/classPrivateFieldSet.js"),l=r.n(u),d=(r(/*! ./style.scss */"./blocks/item-subscribe/style.scss"),r(/*! ~blocks/toggle */"./blocks/toggle/index.js")),h=function(){function e(t){var r=this;s()(this,e),f.set(this,{writable:!0,value:void 0}),p.set(this,{writable:!0,value:void 0}),b.set(this,{writable:!0,value:void 0}),this.el=t,l()(this,b,this.el.querySelector('[data-rel="item.subscribe.status"]')),l()(this,p,this.el.querySelector('[data-rel="item.subscribe.toggle"]')),this.toggle=new d.Toggle(c()(this,p)),this.el.addEventListener("click",(function(){r.active=!r.active})),this.active=this.toggle.active}return i()(e,[{key:"enable",value:function(){this.active=!0}},{key:"disable",value:function(){this.active=!1}},{key:"active",set:function(e){l()(this,f,e),this.toggle.active=e,c()(this,b).innerHTML=e?"Subscribed":"Unsubscribed",this.el.classList.toggle("is-active",e)},get:function(){return c()(this,f)}}]),e}(),f=new WeakMap,p=new WeakMap,b=new WeakMap},"./blocks/item-subscribe/style.scss":
/*!******************************************!*\
...
/*!**********************************!*\
  ...
  \**********************************/
/*! exports provided: Observer */function(e,t,r){"use strict";r.r(t),r.d(t,"Observer",(function(){return o}));var n=new WeakMap,s=new IntersectionObserver((function(e,t){e.filter((function(e){return n.has(e.target)})).forEach((function(e){return function(e){var t=e.entry,r=e.observer,s=t.target,o=t.isIntersecting,i=n.get(s),a=i.once,c=i.callback;return a&&o&&r.unobserve(s),c(o)}({entry:e,observer:t})}))}),{root:null,rootMargin:"0% 0px",threshold:.01}),o={observe:function(e){var t=e.node,r=e.callback,o=e.once,i=void 0!==o&&o;return n.set(t,{callback:r,once:i}),s.observe(t),t},unobserve:function(e){s.unobserve(e),n.delete(e)}}},"./blocks/popup-subscribe/index.js":
/*!*****************************************!*\
  !*** ./blocks/popup-subscribe/index.js ***!
  \*****************************************/
/*! exports provided: PopupSubscribe */function(e,t,r){"use strict";r.r(t),r.d(t,"PopupSubscribe",(function(){return m}));var n,s=r(/*! @babel/runtime/helpers/classCallCheck */"../node_modules/@babel/runtime/helpers/classCallCheck.js"),o=r.n(s),i=r(/*! @babel/runtime/helpers/createClass */"../node_modules/@babel/runtime/helpers/createClass.js"),a=r.n(i),c=r(/*! @babel/runtime/helpers/classPrivateFieldGet */"../node_modules/@babel/runtime/helpers/classPrivateFieldGet.js"),u=r.n(c),l=r(/*! @babel/runtime/helpers/classPrivateFieldSet */"../node_modules/@babel/runtime/helpers/classPrivateFieldSet.js"),d=r.n(l),h=(r(/*! ./style.scss */"./blocks/popup-subscribe/style.scss"),r(/*! ~blocks/popup */"./blocks/popup/index.js")),f=function(){function e(t){o()(this,e),p.set(this,{writable:!0,value:void 0}),b.set(this,{writable:!0,value:void 0}),this.el=t,this.popup=new h.Popup(this.el),d()(this,b,this.el.querySelector('[data-rel="popup.subscribe.result"]'))}return a()(e,[{key:"show",value:function(){return this.popup.open()}},{key:"hide",value:function(){return this.popup.close()}},{key:"value",set:function(e){d()(this,p,e),u()(this,b).innerHTML=0!==e?e>0?"+".concat(e,"%"):"".concat(e,"%"):"",this.el.classList.toggle("popup-subscribe--plus",e>0),this.el.classList.toggle("popup-subscribe--minus",e<0)}}]),e}(),p=new WeakMap,b=new WeakMap,m=(n=document.querySelector("#js-popup-subscribe"),new f(n))},"./blocks/popup-subscribe/style.scss":
/*!*******************************************!*\
...
/*!**********************************!*\
  ...
  \**********************************/
/*! exports provided: Progress */function(e,t,r){"use strict";r.r(t),r.d(t,"Progress",(function(){return d}));var n=r(/*! @babel/runtime/helpers/classCallCheck */"../node_modules/@babel/runtime/helpers/classCallCheck.js"),s=r.n(n),o=r(/*! @babel/runtime/helpers/createClass */"../node_modules/@babel/runtime/helpers/createClass.js"),i=r.n(o),a=r(/*! @babel/runtime/helpers/classPrivateFieldGet */"../node_modules/@babel/runtime/helpers/classPrivateFieldGet.js"),c=r.n(a),u=r(/*! @babel/runtime/helpers/classPrivateFieldSet */"../node_modules/@babel/runtime/helpers/classPrivateFieldSet.js"),l=r.n(u),d=(r(/*! ./style.scss */"./blocks/progress/style.scss"),function(){function e(t){s()(this,e),h.set(this,{writable:!0,value:void 0}),f.set(this,{writable:!0,value:void 0}),p.set(this,{writable:!0,value:void 0}),this.el=t,l()(this,h,this.el.querySelector('[data-rel="progress.line"]')),l()(this,f,this.el.querySelector('[data-rel="progress.label"]')),l()(this,p,this.el.dataset.value),this.value=c()(this,p)}return i()(e,[{key:"value",set:function(e){var t=Math.ceil(e);l()(this,p,t),c()(this,h).style.maxWidth="".concat(t,"%"),c()(this,f).innerHTML="".concat(t,"%"),this.el.dataset.value=t},get:function(){return c()(this,p)}}]),e}()),h=new WeakMap,f=new WeakMap,p=new WeakMap},"./blocks/progress/style.scss":
/*!************************************!*\
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: Toggle */function(e,t,r){"use strict";r.r(t),r.d(t,"Toggle",(function(){return d}));var n=r(/*! @babel/runtime/helpers/classCallCheck */"../node_modules/@babel/runtime/helpers/classCallCheck.js"),s=r.n(n),o=r(/*! @babel/runtime/helpers/createClass */"../node_modules/@babel/runtime/helpers/createClass.js"),i=r.n(o),a=r(/*! @babel/runtime/helpers/classPrivateFieldGet */"../node_modules/@babel/runtime/helpers/classPrivateFieldGet.js"),c=r.n(a),u=r(/*! @babel/runtime/helpers/classPrivateFieldSet */"../node_modules/@babel/runtime/helpers/classPrivateFieldSet.js"),l=r.n(u),d=(r(/*! ./style.scss */"./blocks/toggle/style.scss"),function(){function e(t){s()(this,e),h.set(this,{writable:!0,value:void 0}),f.set(this,{writable:!0,value:void 0}),this.el=t,l()(this,h,this.el.querySelector("input")),l()(this,f,c()(this,h).checked),this.el.addEventListener("click",(function(e){return e.stopPropagation()}))}return i()(e,[{key:"active",set:function(e){c()(this,f)!==e&&this.el.dispatchEvent(new Event("change",{bubbles:!0})),l()(this,f,e),c()(this,h).checked=e},get:function(){return c()(this,f)}}]),e}()),h=new WeakMap,f=new WeakMap},"./blocks/toggle/style.scss":
/*!**********************************!*\
...
/*!*******************************!*\
  ...
  \*******************************/
/*! exports provided: App */function(e,t,r){"use strict";r.r(t),r.d(t,"App",(function(){return u}));var n,s,o,i=r(/*! ~common/styles/breakpoints.scss */"./common/styles/breakpoints.scss"),a=r(/*! ~blocks/breakpoints */"./blocks/breakpoints/index.js"),c=r(/*! ~common/scripts/utils/stream */"./common/scripts/utils/stream.js"),u=(n=console.info,s=new a.Breakpoints(i),o=document.documentElement.getAttribute("lang"),{breakpoints:s,lang:o?o.toLowerCase():null,stream:new c.Stream,debug:n})},"./common/scripts/common.js":
/*!**********************************!*\
